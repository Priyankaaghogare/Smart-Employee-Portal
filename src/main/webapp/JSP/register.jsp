            ...
            <div class="card-body p-5">
              ...
              <form action="save">
                ...
                <div data-mdb-input-init class="form-outline mb-4">
                  <input type="number" name="id" id="form3Example1cg" class="form-control form-control-lg" />
                ...
                <div data-mdb-input-init class="form-outline mb-4">
                  <input type="number" name="age" id="form3Example4cg" class="form-control form-control-lg" />
                  <label class="form-label" for="form3Example4cg">AGE</label>
                </div>
                
                <div data-mdb-input-init class="form-outline mb-4">
                  <input type="number" name="salary" id="form3Example4cg" class="form-control form-control-lg" />
